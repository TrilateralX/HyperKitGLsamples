...
var hyperKitGL_PlyMix = function(width_,height_,hasImage,animate) {
	...
	if(hasImage) {
		...
		haxe_Log.trace(" setup ",{ fileName : "hyperKitGL/PlyMix.js.hx", lineNumber : 112, className : "hyperKitGL.PlyMix", methodName : "setup"});
		var gl = this.gl;
...
hyperKitGL_PlyMix.prototype = {
	...
	,draw: function() {
		haxe_Log.trace("parent draw",{ fileName : "hyperKitGL/PlyMix.js.hx", lineNumber : 161, className : "hyperKitGL.PlyMix", methodName : "draw"});
	}
...
function hyperKitGLsamples_gradientGrid_Main_main() {
	...
	haxe_Log.trace("Gradient Grid Test",{ fileName : "../../../src/hyperKitGLsamples/gradientGrid/Main.hx", lineNumber : 41, className : "hyperKitGLsamples.gradientGrid._Main.Main_Fields_", methodName : "main"});
}

...
var hyperKitGLsamples_sliderPuzzle_SliderPuzzle = function(width,height) {
	...
	haxe_Log.trace("draw",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 73, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "new"});
...
hyperKitGLsamples_sliderPuzzle_SliderPuzzle.prototype = $extend(hyperKitGL_PlyMix.prototype,{
	draw: function() {
		haxe_Log.trace("arrow keys or mouse for direction",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 103, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		haxe_Log.trace("space to muddle",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 104, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		haxe_Log.trace("enter to solve",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 105, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		haxe_Log.trace("delete to undo",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 106, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
...
function hyperKitGLsamples_sliderPuzzle_SliderPuzzle_main() {
	...
	haxe_Log.trace("TrilateralSliderPuzzle example",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 40, className : "hyperKitGLsamples.sliderPuzzle._SliderPuzzle.SliderPuzzle_Fields_", methodName : "main"});
}

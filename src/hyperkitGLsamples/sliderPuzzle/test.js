...
hyperKitGL_XY.prototype = {
	clone: function() {
		return new hyperKitGL_XY(this.x,this.y);
	}
};
...
var hyperKitGLsamples_imageEncode_TableCloth = function() { };
hyperKitGLsamples_imageEncode_TableCloth.__name__ = true;
var hyperKitGLsamples_sliderPuzzle_NextToCore = function(width,item,target) {
	this.width = width;
	this.item = item;
	this.target = target;
};
hyperKitGLsamples_sliderPuzzle_NextToCore.__name__ = true;
var hyperKitGLsamples_sliderPuzzle_SliderPuzzle = function(width,height) {
	this.lastRnd = 0;
	this.step = 0.12;
	this.t = 0.;
	...
	haxe_Log.trace("draw",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 74, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "new"});
	this.imageLoader.loadEncoded([hyperKitGLsamples_imageEncode_TableCloth.png_],["tableCloth"]);
};
hyperKitGLsamples_sliderPuzzle_SliderPuzzle.__name__ = true;
hyperKitGLsamples_sliderPuzzle_SliderPuzzle.__super__ = hyperKitGL_PlyMix;
hyperKitGLsamples_sliderPuzzle_SliderPuzzle.prototype = $extend(hyperKitGL_PlyMix.prototype,{
	draw: function() {
		haxe_Log.trace("arrow keys or mouse for direction",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 105, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		haxe_Log.trace("space to muddle",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 106, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		haxe_Log.trace("enter to solve",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 107, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		haxe_Log.trace("delete to undo",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 108, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
		...
		haxe_Log.trace((this.penNoduleTexture.colorTriangles.length - 1) * 3 | 0,{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 135, className : "hyperKitGLsamples.sliderPuzzle.SliderPuzzle", methodName : "draw"});
	...
	,keyDown: function(e) {
		...
		if(keyCode == 8) {
			...
			var this1 = new hyperKitGLsamples_sliderPuzzle_NextToCore(this.nW,countNo,this.last);
		...
		case 37:
			this.step = 0.12;
			var this1 = new hyperKitGLsamples_sliderPuzzle_NextToCore(this.nW,this.last,this.last);
	...
	,swapLasts: function() {
		...
		var xy0 = new hyperKitGL_XY(_this1.curr.get_x() * _this1.wid + _this1.wid,-(_this1.curr.get_y() * _this1.hi - _this1.hi));
		var _this = this.quadDepth.depthPieces[d1];
		var v = _this.start;
		_this.pen.paintType.set_pos(v);
		var _this1 = _this.tri;
		var xy1 = new hyperKitGL_XY(_this1.curr.get_x() * _this1.wid + _this1.wid,-(_this1.curr.get_y() * _this1.hi - _this1.hi));
		var dx = xy0.x - xy1.x;
		var dy = xy0.y - xy1.y;
		var dxy = new hyperKitGL_XY(dx,dy);
		...
		var val = xy0.y;
		var val_ = -(val - _this1.hi) / _this1.hi;
...
function hyperKitGLsamples_sliderPuzzle_SliderPuzzle_main() {
	new hyperKitGLsamples_sliderPuzzle_SliderPuzzle(1000,1000);
	var divertTrace = new hyperKitGL_DivertTrace();
	haxe_Log.trace("TrilateralSliderPuzzle example",{ fileName : "../../../src/hyperKitGLsamples/sliderPuzzle/SliderPuzzle.hx", lineNumber : 41, className : "hyperKitGLsamples.sliderPuzzle._SliderPuzzle.SliderPuzzle_Fields_", methodName : "main"});
}
...
trilateral3_reShape_QuadDepth.prototype = {
			...
			while(_g2 < _g3) {
				...
				if(onlyCreate != null) {
					if(onlyCreate.indexOf(count) != -1) {
						...
						var pos = new hyperKitGL_XY(u + x + this.space * col,v + y + this.space * row);
						var p = quad.pen.paintType.get_pos();
						var v1 = quad.start;
						...
						if(tmp) {
							...
							var _this4 = quad.tri;
							quad.lastXY = new hyperKitGL_XY(_g4,-(_this4.curr.get_y() * _this4.hi - _this4.hi));
						}
						var _this5 = quad.tri;
						var val = pos.x;
						...
						var val1 = pos.y;
						var val_1 = -(val1 - _this5.hi) / _this5.hi;
						...
						var val3 = pos.y;
						var val_3 = -(val3 - _this6.hi) / _this6.hi;
						_this6.curr.set_y(val_3);
						quad.pen.paintType.set_pos(p);
					...
					var pos1 = new hyperKitGL_XY(u + x + this.space * col,v + y + this.space * row);
					var p1 = quad1.pen.paintType.get_pos();
					var v3 = quad1.start;
					...
					if(tmp1) {
						...
						quad1.lastXY = new hyperKitGL_XY(_g5,-(_this11.curr.get_y() * _this11.hi - _this11.hi));
					}
					...
					var val5 = pos1.y;
					var val_5 = -(val5 - _this12.hi) / _this12.hi;
					...
					var val7 = pos1.y;
					var val_7 = -(val7 - _this13.hi) / _this13.hi;
					_this13.curr.set_y(val_7);
					quad1.pen.paintType.set_pos(p1);
	...
	,getXY: function(id) {
		...
		_this.pen.paintType.set_pos(v);
		var _this1 = _this.tri;
		return new hyperKitGL_XY(_this1.curr.get_x() * _this1.wid + _this1.wid,-(_this1.curr.get_y() * _this1.hi - _this1.hi));
	}
	...
	,toTop: function(pieceNo) {
		var startpos = this.depthPieces[pieceNo].start | 0;
		var updatePieces;

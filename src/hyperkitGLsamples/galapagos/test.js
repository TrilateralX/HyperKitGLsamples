...
hyperKitGLsamples_galapagos_Galapagos.prototype = $extend(hyperKitGL_PlyMix.prototype,{
	draw: function() {
		...
		haxe_Log.trace(hyperKitGL_io_Float32Flat.get_size(this.penColor.colorTriangles) * 3 | 0,{ fileName : "../../../src/hyperKitGLsamples/galapagos/Galapagos.hx", lineNumber : 257, className : "hyperKitGLsamples.galapagos.Galapagos", methodName : "testDot"});
...
hyperKitGLsamples_galapagos_View.prototype = {
	...
	,drawDot: function(cx,cy,radius) {
		...
		while(_g < _g1) {
			...
			haxe_Log.trace("add2DTriangle ShaperPen " + pen.currentColor,{ fileName : "trilateral3/shape/ShaperPen.hx", lineNumber : 39, className : "trilateral3.shape._ShaperPen.ShaperPen_Fields_", methodName : "add2DTriangle"});

...
var hyperKitGLsamples_galapagos_Galapagos = function(width,height) {
	...
	this._newPath = false;
	this.draw_Shape = [];
	this.penTexture = new trilateral3_nodule_PenTexture();
...
hyperKitGLsamples_galapagos_Galapagos.prototype = $extend(hyperKitGL_PlyMix.prototype,{
	draw: function() {
		...
		this.dataGLtexture = { get_data : ($_=this.penTexture,$bind($_,$_.get_data)), get_size : ($_=this.penTexture,$bind($_,$_.get_size))};
		this.penC = this.penColor.pen;
		this.penC.currentColor = -65281;
		this.penT = this.penTexture.pen;
		this.penT.useTexture = true;
		this.penT.currentColor = -1;
		haxe_Log.trace("draw, " + Std.string(this.penC),{ fileName : "../../../src/hyperKitGLsamples/galapagos/Galapagos.hx", lineNumber : 143, className : "hyperKitGLsamples.galapagos.Galapagos", methodName : "draw"});
		this._view = new hyperKitGLsamples_galapagos_View(this.penColor);
		var pixels = hxPixels_Pixels.fromImageData(surface.getImageData(0,0,w_bw,h_bw));
		this.buildPathFinder(pixels);
		this.posMin = this.penC.paintType.get_pos() | 0;
		this._view.lineStyle(40,-65536,1.);
		this._view.drawCircle(100.,100.,30.);
		haxe_Log.trace((this.penColor.colorTriangles[1] | 0) * 3 | 0,{ fileName : "../../../src/hyperKitGLsamples/galapagos/Galapagos.hx", lineNumber : 257, className : "hyperKitGLsamples.galapagos.Galapagos", methodName : "testDot"});
		var tmp = this.draw_Shape;
		var tmp1 = this.draw_Shape.length;
		var ii_min = this.posMin;
		var ii_max = this.penC.paintType.get_pos() | 0;
		var this1 = new trilateral3_shape_IntIterStart(ii_min,ii_max);
		tmp[tmp1] = new trilateral3_structure_RangeEntity(false,this1,-1);
		haxe_Log.trace("draw_Shape.range " + Std.string(this.draw_Shape[this.draw_Shape.length - 1].range),{ fileName : "../../../src/hyperKitGLsamples/galapagos/Galapagos.hx", lineNumber : 262, className : "hyperKitGLsamples.galapagos.Galapagos", methodName : "testDot"});
	}
...
var hyperKitGLsamples_galapagos_View = function(penColor) {
	this._inFillingMode = false;
	this._fillColor = -16711936;
	this._lineColor = -16776961;
	this._prevY = 0;
	this._prevX = 0;
	...
	haxe_Log.trace("new view " + this.pen.currentColor,{ fileName : "../../../src/hyperKitGLsamples/galapagos/View.hx", lineNumber : 66, className : "hyperKitGLsamples.galapagos.View", methodName : "new"});
...
hyperKitGLsamples_galapagos_View.prototype = {
	...
	,drawVertex: function(vertex) {
		haxe_Log.trace("vertex " + Std.string(vertex.get_pos()),{ fileName : "../../../src/hyperKitGLsamples/galapagos/View.hx", lineNumber : 169, className : "hyperKitGLsamples.galapagos.View", methodName : "drawVertex"});
...
trilateral3_nodule_PenColor.prototype = $extend(trilateral3_nodule_PenNodule.prototype,{
	createPen: function() {
		...
		var paintAbstract = { triangle : function(ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
			...
			return hyperKitGL_io_Float32FlatDepth.rangeToEnd(_e38,id * 21,21 * len | 0,21 * (_e38[1] | 0));
		}, swap : function(id0,id1,len) {
			var start0 = id0 * 21;
			var start1 = id1 * 21;
			var totalLen = 21 * len | 0;
			if(start0 + totalLen > (_e39[1] | 0) && start1 + totalLen > (_e39[1] | 0)) {
				var temp0;
				var temp1;
				var _g = 0;
				var _g1 = totalLen;
	...
	,get_data: function() {
		...
		return this1.subarray(2,(this1[1] | 0) * 21 + 2);
	}
	,get_size: function() {
		return (this.colorTriangles[1] | 0) * 3 | 0;
	}
});
...
trilateral3_nodule_PenTexture.prototype = $extend(trilateral3_nodule_PenNodule.prototype,{
	createPen: function() {
		...
		var paintAbstract = { triangle : function(ax_,ay_,az_,bx_,by_,bz_,cx_,cy_,cz_) {
			...
			var start1 = id1 * 27;
			var totalLen = 27 * len | 0;
			if(start0 + totalLen > (_e50[1] | 0) && start1 + totalLen > (_e50[1] | 0)) {
				var temp0;
				var temp1;
				var _g = 0;
				var _g1 = totalLen;
	...
	,get_data: function() {
		var this1 = this.colorTriangles;
		return this1.subarray(2,(this1[1] | 0) * 27 + 2);
	}
	,get_size: function() {
		return (this.colorTriangles[1] | 0) * 3 | 0;
	}

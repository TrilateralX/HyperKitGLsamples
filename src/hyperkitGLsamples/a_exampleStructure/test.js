...
var hyperKitGLsamples_a_$exampleStructure_Main = function(width,height,flower) {
	trilateral3base_TrilateralBase.call(this,width,height,flower);
};
hyperKitGLsamples_a_$exampleStructure_Main.__name__ = true;
hyperKitGLsamples_a_$exampleStructure_Main.__super__ = trilateral3base_TrilateralBase;
hyperKitGLsamples_a_$exampleStructure_Main.prototype = $extend(trilateral3base_TrilateralBase.prototype,{
	firstDraw: function() {
		haxe_Log.trace("** draw/construct everything  **",{ fileName : "../../../src/hyperKitGLsamples/a_exampleStructure/Main.hx", lineNumber : 14, className : "hyperKitGLsamples.a_exampleStructure.Main", methodName : "firstDraw"});
	}
	,renderAnimate: function() {
		haxe_Log.trace("-- render/animate everything --",{ fileName : "../../../src/hyperKitGLsamples/a_exampleStructure/Main.hx", lineNumber : 17, className : "hyperKitGLsamples.a_exampleStructure.Main", methodName : "renderAnimate"});
	}
});
function hyperKitGLsamples_a_$exampleStructure_Main_main() {
	new hyperKitGLsamples_a_$exampleStructure_Main(1000,1000,hyperKitGLsamples_imageEncode_Flower.png_);
}
...
hyperKitGLsamples_a_$exampleStructure_Main_main();
